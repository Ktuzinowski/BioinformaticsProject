...
def create_reference(work_path, gene, soft):
    ...
    :return:
    """
    gene = gene.replace('.fasta', '.gar')
    path_reference = work_path + f"References/Exon_maps/"
                ...
                try:
                    ...
                    for nuc_intronique in range(1, end + 1):
                        if nuc_intronique not in nuc_exonique:
                            nuc_intron_pred.append(nuc_intronique)

                    dico_transcrit[cle].append(nuc_intron_pred)
...
def create_prediction_augustus(gene, add_nuc, path_pred):
    ...
    soft = "augustus"
    # Interesting place to look into
    ...
    if file.exists():
        ...
        if "# (none)" in a.read():
            ...
            try:
                ...
                pass
        #print(nuc_exon_pred_exon, nuc_exon_pred_cds, nuc_intron_pred_exon, nuc_intron_pred_cds)
        return nuc_exon_pred_exon, nuc_exon_pred_cds, nuc_intron_pred_exon, nuc_intron_pred_cds
...
if __name__ == '__main__':
    ...
    workpath = "/Users/kevintuzinowski/Studies/Benchmark_study-master/"
